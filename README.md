...
- [О технической реализации проекта](#techs) 
	...
	- [Доступные Scripts](#scripts) 
	- [Обработка ошибок, Кэширование и ревалидация данных с сервера](#data_handling)
		- [Кэширование идёт с помощью хука useEffect и localStorage](#caching) 
	- [Nginx & Docker](#nginx_docker) 
		- [Nginx](#nginx) 
		- [Docker](#docker) 
...
<a name="diagrams_buttons"><h2>Кнопки диаграмм</h2></a>
...
<a name="demo_buttons"><h2>Кнопки Демонстрации отработки ошибок при роутинге и отлове ошибок при fetch</h2></a>
...
<a name="techs"><h1>О технической реализации проекта</h1></a>
<a name="git_flow"><h2>Git Flow</h2></a>
> [!IMPORTANT]
> Применён Git Flow:
...
<a name="main_stack"><h2>Основной стек </h2></a>
...
```
<a name="state_managers"><h2>State Managers</h2></a>
...
<a name="scripts"><h2>Доступные Scripts</h2></a>
...
**Указание**: это одностороннее действие. Если вы используете команду `eject`, вам не вернуться обратно!
...
<a name="data_handling"><h2>Обработка ошибок, Кэширование и ревалидация данных с сервера</h2></a>
...
<a name="caching"><h3>Кэширование с помощью хука useEffect и localStorage</h3></a>
...
<a name="nginx_docker"><h2>Nginx & Docker</h2></a>

<a name="nginx"><h3>Nginx</h3></a>
> [!NOTE]
